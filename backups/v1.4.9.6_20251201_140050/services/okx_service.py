# -*- coding: utf-8 -*-
"""
T-TARS OKX Service v1.4.9.4
===========================
OKX Exchange Service - Market Data + Smart Money Detection

v1.4.9.4:
- ATR round(atr, 8) - SHIB/DOGE gibi düşük fiyatlı coinler için
"""
...
class OKXService:
    ...
    def calculate_atr(self, ticker="BTC/USDT", timeframe='1d', period=14):
        """ATR(14) hesapla - v1.4.9.4: round(8) for low price coins"""
        try:
            ...
            return round(atr, 8)  # v1.4.9.4: 8 decimal for SHIB/DOGE
        except Exception as e:
    ...
    def calculate_fibonacci(self, ticker="BTC/USDT", use_pdc=True):
        ...
        try:
            ...
            result = {
                ...
                'levels': {k: round(v, 8) for k, v in levels.items()}  # v1.4.9.4: 8 decimal
            }
    ...
    def calculate_stop_loss(self, ticker="BTC/USDT", fixed_amount=1000):
        ...
        try:
            ...
            return {
                'current_price': round(current_price, 8),  # v1.4.9.4
                'stop_price': round(stop_price, 8),  # v1.4.9.4
