...
- Mevcut market data fonksiyonları korundu
"""
...
class OKXService:
    ...
    def place_order_with_tp_sl(self, symbol, side, amount, tp_price=None, sl_price=None):
        """
        TP/SL ile market order aç
        ...
        try:
            ...
            logger.info(f"✅ Market {side.upper()} order with TP/SL: {symbol} x{amount}")
    ...
    def close_position(self, symbol, side=None):
        ...
        Args:
            symbol: 'BTC/USDT:USDT' veya 'BTCUSDT'
            side: 'buy' veya 'sell' (None ise otomatik tespit)
    ...
    def get_open_orders(self, symbol=None):
        ...
        Args:
            symbol: Optional - specific symbol, None for all
    ...
    def get_pnl_summary(self):
        """
        P/L özeti - Pozisyonlardan hesapla
    ...
    # ============================================
    # MARKET DATA (Mevcut fonksiyonlar - değişmedi)
    # ============================================
