...
class OKXService:
    ...
    def get_complete_analysis_data(self, ticker="BTC/USDT"):
        ...
        try:
            ...
            atr_5m = self.calculate_atr(ticker, '5m', 14)  # ← YENİ 5m
            ...
            ohlcv_5m = self.get_ohlcv(ticker, '5m', limit=30)  # ← YENİ 5m
            ...
            volume_5m = self.analyze_volume(ohlcv_5m, lookback=20)  # ← YENİ 5m
            ...
            obs_5m = self.detect_order_blocks(ticker, '5m', lookback=50)  # ← YENİ 5m
            ...
            fvgs_5m = self.detect_fair_value_gaps(ticker, '5m', lookback=50)  # ← YENİ 5m
